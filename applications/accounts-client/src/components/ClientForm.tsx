          ...
          <Row>
            ...
            <Col xs={12}>
              <Card padding="lg">
                ...
                <TextBox
                  name="contact.email"
                  label={t('client-form.contact.email.label')}
                />

                <TextBox
                  name="contact.telephone"
                  label={t('client-form.contact.telephone.label')}
                />
              </Card>
            </Col>
          </Row>
          ...
          <Row>
            <Col xs={12}>
              <Card padding="lg">
                ...
                <TextBox
                  name="address.line1"
                  label={t('client-form.address.line1.label')}
                />

                <TextBox
                  name="address.line2"
                  label={t('client-form.address.line2.label')}
                />

                <TextBox
                  name="address.line3"
                  label={t('client-form.address.line3.label')}
                />

                <TextBox
                  name="address.line4"
                  label={t('client-form.address.line4.label')}
                />

                <TextBox
                  name="address.line5"
                  label={t('client-form.address.line5.label')}
                />
              </Card>
            </Col>
          </Row>
