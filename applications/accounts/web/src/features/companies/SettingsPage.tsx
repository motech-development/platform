...
function reconcileCategoryKeys(
  previousCategories: CompanySettings['categories'],
  previousKeys: string[],
  ...
  useEffect(() => {
    ...
    setCategoryKeys((keys) =>
      reconcileCategoryKeys(
        ...
        () => {
          const key = `category-${keyCounter.current}`;
                    ...
                    {categories.map((category, index) => {
                      ...
                      return (
                        <div
                          ...
                          key={
                            categoryKeys[index] ?? `${category.name}-${index}`
                          }
                        >
                    ...
                    {(field) => {
                      ...
                      return (
                        <PercentageField
                          ...
                          invalid={errors.length > 0}
                          label={t(
                            name === 'charge' ? 'Charge rate' : 'Pay rate',
                          )}
                          onBlur={field.handleBlur}
                          onChange={(value) => {
                            field.handleChange(value);
