...
type Documents = {
    ...
    "\n  fragment TransactionCacheValue on Transaction {\n    amount\n    attachment\n    category\n    companyId\n    date\n    description\n    id\n    name\n    refund\n    scheduled\n    status\n    vat\n  }\n": typeof types.TransactionCacheValueFragmentDoc,
};
const documents: Documents = {
    ...
    "\n  query PendingTransactions(\n    $id: ID!\n    $status: TransactionStatus!\n    $count: Int\n    $nextToken: String\n  ) {\n    getBalance(id: $id) {\n      id\n      currency\n    }\n    getTransactions(\n      id: $id\n      status: $status\n      count: $count\n      nextToken: $nextToken\n    ) {\n      id\n      status\n      transactionLoadedPageCount @client\n      transactionRequestedPageCount @client\n      transactionRefreshGeneration @client\n      items {\n        id\n        amount\n        attachment\n        category\n        companyId\n        date\n        description\n        name\n        refund\n        scheduled\n        status\n        vat\n      }\n      nextToken\n    }\n  }\n": types.PendingTransactionsDocument,
    ...
    "\n  fragment TransactionCacheValue on Transaction {\n    amount\n    attachment\n    category\n    companyId\n    date\n    description\n    id\n    name\n    refund\n    scheduled\n    status\n    vat\n  }\n": types.TransactionCacheValueFragmentDoc,
};
