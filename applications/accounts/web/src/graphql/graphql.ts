...
export type AccountsWebCompaniesQuery = { getCompanies: { id: string, items: Array<{ id: string, name: string, companyNumber: string, address: { line1: string, line2: string | null, line3: string, line4: string | null, line5: string }, bank: { accountNumber: string, sortCode: string }, contact: { email: string, telephone: string } }> } };
