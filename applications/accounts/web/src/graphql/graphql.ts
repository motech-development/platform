...
export type DashboardQuery = { getCompany: { id: string, name: string, companyNumber: string }, getBalance: { id: string, balance: number, currency: string, vat: { owed: number, paid: number } }, getTransactions: { id: string, status: TransactionStatus, nextToken: string | null, items: Array<{ id: string, amount: number, attachment: string | null, category: string, date: string, description: string, name: string, scheduled: boolean, status: TransactionStatus }> }, pendingTransactions: { id: string, status: TransactionStatus, nextToken: string | null, items: Array<{ id: string, amount: number, attachment: string | null, category: string, date: string, description: string, name: string, scheduled: boolean, status: TransactionStatus }> } };
...
export type PendingTransactionsQuery = { getBalance: { id: string, currency: string }, getTransactions: { id: string, status: TransactionStatus, transactionLoadedPageCount: number, transactionRequestedPageCount: number, transactionRefreshGeneration: number, nextToken: string | null, items: Array<{ id: string, amount: number, attachment: string | null, category: string, companyId: string, date: string, description: string, name: string, refund: boolean, scheduled: boolean, status: TransactionStatus, vat: number }> } };
