...
export type CompaniesQuery = { getCompanies: { id: string, items: Array<{ id: string, name: string, companyNumber: string, contact: { email: string } }> } };
...
export type ClientsQuery = { getClients: { id: string, nextToken: string | null, items: Array<{ companyId: string, id: string, name: string, address: { line1: string, line2: string | null, line3: string, line4: string | null, line5: string }, contact: { email: string, telephone: string } }> } };
...
export type RecordTransactionQuery = { getClients: { id: string, items: Array<{ id: string, name: string }> }, getSettings: { id: string, vat: { pay: number } } };
