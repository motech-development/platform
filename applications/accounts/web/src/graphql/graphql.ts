...
export type AccountsWebClientsQuery = { getClients: { id: string, items: Array<{ companyId: string, id: string, name: string, address: { line1: string, line2: string | null, line3: string, line4: string | null, line5: string }, contact: { email: string, telephone: string } }> } };
