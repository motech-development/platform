...
const documents: Documents = {
  '\n                  fragment NewReport on Report {\n                    id\n                    createdAt\n                    downloadUrl\n                    ttl\n                  }\n                ':
    types.NewReportFragmentDoc,
  '\n              fragment NewNotification on Notification {\n                id\n                createdAt\n                message\n                owner\n                payload\n                read\n              }\n            ':
    types.NewNotificationFragmentDoc,
  '\n  subscription OnTransactionChange($id: ID!, $owner: String!) {\n    onTransactionChange(id: $id, owner: $owner) {\n      id\n      owner\n      transactionId\n    }\n  }\n':
    types.OnTransactionChangeDocument,
  '\n  query GetTransactionState($companyId: ID!, $transactionId: ID!) {\n    getTransactionState(companyId: $companyId, transactionId: $transactionId) {\n      amount\n      attachment\n      category\n      companyId\n      date\n      description\n      id\n      name\n      refund\n      scheduled\n      status\n      vat\n    }\n  }\n':
    types.GetTransactionStateDocument,
  '\n  query GetBalance(\n    $count: Int\n    $id: ID!\n    $status: TransactionStatus!\n    $nextToken: String\n  ) {\n    getBalance(id: $id) {\n      balance\n      currency\n      id\n      vat {\n        owed\n        paid\n      }\n    }\n    getTransactions(\n      count: $count\n      id: $id\n      status: $status\n      nextToken: $nextToken\n    ) {\n      id\n      items {\n        amount\n        attachment\n        date\n        description\n        id\n        name\n      }\n      nextToken\n      status\n    }\n  }\n':
