...
Report the observed behaviour and verdict with the runnable HTML file. If production implementation is also authorized, transfer the validated decision into the real module with appropriate production checks. Follow the [scope and completion rules](SKILL.md) for any branch or issue updates.
