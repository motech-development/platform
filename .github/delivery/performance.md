...
| ----------------------- | ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| ClamAV source build     | Included in the 325s combined step | [Preview run 29937430985](https://github.com/motech-development/platform/actions/runs/29937430985): 183s source-build miss |
| ClamAV cache restore    | Not present                        | [Preview run 29937430985](https://github.com/motech-development/platform/actions/runs/29937430985): under 1s, cache miss   |
| ClamAV cache validation | Not present                        | [Preview run 29937430985](https://github.com/motech-development/platform/actions/runs/29937430985): under 1s, cache miss   |
| Anti-virus packaging    | Included in the 325s combined step | [Preview run 29937430985](https://github.com/motech-development/platform/actions/runs/29937430985): 88s                    |
| Anti-virus overall job  | 385s                               | [Preview run 29937430985](https://github.com/motech-development/platform/actions/runs/29937430985): 549s                   |
| Package equivalence     | Not tested                         | Cached/uncached archive inspection: six equivalent Lambda zips                                                             |

The first post-change source-build run establishes the miss baseline and saved the versioned binary cache. Its overall time includes a 19s definitions update that the pre-change reference did not run. The next unchanged anti-virus deployment must establish the hit baseline before assessing the cache improvement. Local package inspection remains correctness evidence rather than a substitute for runner timing.
