...
const tableRoot = tv({
  ...
  variants: {
    ...
    layout: {
      grid: `${compactGridTableLayout} ${desktopGridTableLayout}`,
      responsive: responsiveTableLayout,
      responsiveGrid: `${responsiveTableLayout} ${desktopGridTableLayout}`,
    },
    virtualized: {
      false: '',
