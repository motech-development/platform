import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{n,t as r}from"./FormattedList-CoLL_flf.js";var i=t({Conjunction:()=>o,Disjunction:()=>s,__namedExportsOrder:()=>c,default:()=>a}),a,o,s,c,l=e((()=>{n(),a={component:r,title:`Formatting/FormattedList`},o={args:{values:[`PDF`,`JPG`,`PNG`]}},s={args:{options:{type:`disjunction`},values:[`Email`,`telephone`,`post`]}},o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    values: ['PDF', 'JPG', 'PNG']
  }
