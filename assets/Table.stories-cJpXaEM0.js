...
}`,...M.parameters?.docs?.source},description:{story:`Authors columns and rows directly while the application controls selected
keys and the consumer-owned sort descriptor.

@summary explicitly authored table with controlled sorting and selection`,...M.parameters?.docs?.description}}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...N.parameters?.docs?.source},description:{story:`Composes keyed static header, body, and footer sections whose cells follow
the visible heading order and retain long-value wrapping.

@summary static ordered header body and footer sections`,...N.parameters?.docs?.description}}},P.parameters={...P.parameters,docs:{...P.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...P.parameters?.docs?.source},description:{story:`Adds the canonical strong lower boundary without introducing top or side
borders, preserving the table's relationship to surrounding content.

@summary table with a strong lower boundary`,...P.parameters?.docs?.description}}},F.parameters={...F.parameters,docs:{...F.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...F.parameters?.docs?.source},description:{story:`Uses persistent CSS-grid rows across multiple keyed body sections so every
cell stays aligned with its corresponding heading track.

@summary persistent grid layout with grouped body sections`,...F.parameters?.docs?.description}}},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...I.parameters?.docs?.source},description:{story:`Uses a named five-column desktop arrangement while retaining compact card
rows below the Breeze small breakpoint.

@summary typed media, details, and action desktop grid columns`,...I.parameters?.docs?.description}}},L.parameters={...L.parameters,docs:{...L.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...L.parameters?.docs?.source},description:{story:`Removes supporting desktop-only columns and their grid tracks at the compact
breakpoint while preserving spanning and keyboard geometry.

@summary compact grid omits hidden tracks`,...L.parameters?.docs?.description}}},R.parameters={...R.parameters,docs:{...R.parameters?.docs,source:{originalSource:`{
  args: {
  ...
  render: () => <Table.Root aria-label="Compact consumer records" layout="responsiveGrid">
      ...
      <Table.Body className="max-[681px]:block!">
        <Table.Row className="max-[681px]:grid! max-[681px]:grid-cols-[2.25rem_minmax(0,1fr)_2.25rem]" id="acme" textValue="Acme Ready">
          <Table.Cell className="max-[681px]:col-start-2 max-[681px]:row-start-1" column="name">
            Acme
          </Table.Cell>
          <Table.Cell className="max-[681px]:col-span-3 max-[681px]:row-start-2" column="status">
            Ready
          </Table.Cell>
        </Table.Row>
      </Table.Body>
    </Table.Root>
}`,...R.parameters?.docs?.source},description:{story:`Preserves consumer-owned compact grid placement for cells that do not use
the compound API's \`colSpan\` contract.

@summary compact grid honours consumer cell placement`,...R.parameters?.docs?.description}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
...
Excluded when sorting is uncontrolled.`,name:`sort`,parent:{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},required:!1,tags:{},type:{name:`TableSort | undefined`}},onSortChange:{defaultValue:null,declarations:[{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`UncontrolledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`UncontrolledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`UncontrolledTableSortProps`}],description:`Called when a sortable heading requests a new descriptor.
Called when the internally retained descriptor changes.`,name:`onSortChange`,parent:{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},required:!1,tags:{},type:{name:`((sort: TableSort) => void) | ((sort: TableSort) => void) | undefined`}},defaultSort:{defaultValue:null,declarations:[{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`UncontrolledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`UncontrolledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`UncontrolledTableSortProps`}],description:`Excluded when sorting is controlled.
Initial sort descriptor.`,name:`defaultSort`,parent:{fileName:`breeze-ui/src/primitives/Table/Table.tsx`,name:`ControlledTableSortProps`},required:!1,tags:{},type:{name:`TableSort | undefined`}}},tags:{}}}catch{}try{M.displayName=`ControlledSortingAndSelection`,M.__docgenInfo={description:`Authors columns and rows directly while the application controls selected
keys and the consumer-owned sort descriptor.`,displayName:`ControlledSortingAndSelection`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`explicitly authored table with controlled sorting and selection`}}}catch{}try{N.displayName=`StaticOrderedSections`,N.__docgenInfo={description:`Composes keyed static header, body, and footer sections whose cells follow
the visible heading order and retain long-value wrapping.`,displayName:`StaticOrderedSections`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`static ordered header body and footer sections`}}}catch{}try{P.displayName=`StrongBoundary`,P.__docgenInfo={description:`Adds the canonical strong lower boundary without introducing top or side
borders, preserving the table's relationship to surrounding content.`,displayName:`StrongBoundary`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`table with a strong lower boundary`}}}catch{}try{F.displayName=`GridGroupedSections`,F.__docgenInfo={description:`Uses persistent CSS-grid rows across multiple keyed body sections so every
cell stays aligned with its corresponding heading track.`,displayName:`GridGroupedSections`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`persistent grid layout with grouped body sections`}}}catch{}try{I.displayName=`ResponsiveGridColumnVariant`,I.__docgenInfo={description:`Uses a named five-column desktop arrangement while retaining compact card
rows below the Breeze small breakpoint.`,displayName:`ResponsiveGridColumnVariant`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`typed media, details, and action desktop grid columns`}}}catch{}try{L.displayName=`CompactGridColumns`,L.__docgenInfo={description:`Removes supporting desktop-only columns and their grid tracks at the compact
breakpoint while preserving spanning and keyboard geometry.`,displayName:`CompactGridColumns`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`compact grid omits hidden tracks`}}}catch{}try{R.displayName=`CompactConsumerGridPlacement`,R.__docgenInfo={description:"Preserves consumer-owned compact grid placement for cells that do not use\nthe compound API's `colSpan` contract.",displayName:`CompactConsumerGridPlacement`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`compact grid honours consumer cell placement`}}}catch{}try{z.displayName=`CompactGridSpanningVisibility`,z.__docgenInfo={description:`Keeps a span visible when any covered column remains in the compact grid and
...
than teaching Table application commands or business workflows.`,displayName:`ActionsStayWithApplications`,filePath:`/home/runner/work/platform/platform/packages/breeze-ui/src/primitives/Table/Table.stories.tsx`,methods:[],props:{},tags:{summary:`application-owned action inside a table cell`}}}catch{}Rt=[`ControlledSortingAndSelection`,`StaticOrderedSections`,`StrongBoundary`,`GridGroupedSections`,`ResponsiveGridColumnVariant`,`CompactGridColumns`,`CompactConsumerGridPlacement`,`CompactGridSpanningVisibility`,`DesktopGridColumnSpan`,`ResponsiveGridColumnWidths`,`ResponsiveGroupedSections`,`RowTonesAndSections`,`RowTonesAndSectionsCompact`,`ResponsiveItems`,`ResponsiveItemsCompact`,`ConditionalOrderedColumns`,`ReadOnlyAndEmpty`,`VariableVirtualizationAndLoading`,`VariableVirtualizationAndLoadingCompact`,`VariableVirtualizationNarrowDesktop`,`VariableVirtualizationCompactBoundaries`,`ActionsStayWithApplications`]}));zt();export{$ as ActionsStayWithApplications,R as CompactConsumerGridPlacement,L as CompactGridColumns,z as CompactGridSpanningVisibility,q as ConditionalOrderedColumns,M as ControlledSortingAndSelection,B as DesktopGridColumnSpan,F as GridGroupedSections,J as ReadOnlyAndEmpty,I as ResponsiveGridColumnVariant,V as ResponsiveGridColumnWidths,H as ResponsiveGroupedSections,G as ResponsiveItems,K as ResponsiveItemsCompact,U as RowTonesAndSections,W as RowTonesAndSectionsCompact,N as StaticOrderedSections,P as StrongBoundary,Y as VariableVirtualizationAndLoading,X as VariableVirtualizationAndLoadingCompact,Q as VariableVirtualizationCompactBoundaries,Z as VariableVirtualizationNarrowDesktop,Rt as __namedExportsOrder,Ft as default,zt as n,St as t};