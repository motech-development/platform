import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{i as n}from"./react-XnqUzw--.js";import{c as r,n as i,r as a,s as o}from"./blocks-CCzR2RK4.js";import{t as s}from"./mdx-react-shim-y1jXGhTh.js";import{CompleteFrame as c,n as l,t as u}from"./ApplicationShell.stories-BcmEz4aa.js";function d(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,ul:`ul`,...n(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(o,{of:u,summary:`Responsive application frame that composes brand, navigation, context, account controls, skip navigation, and page content.`}),`
...
`,(0,p.jsxs)(t.p,{children:[`The root contains a visible-on-focus skip link, a persistent rail from the `,(0,p.jsx)(t.code,{children:`md`}),` breakpoint, a compact header and start-edge drawer below `,(0,p.jsx)(t.code,{children:`md`}),`, and the labelled main-content target. `,(0,p.jsx)(t.code,{children:`brand`}),`, `,(0,p.jsx)(t.code,{children:`navigation`}),`, and optional `,(0,p.jsx)(t.code,{children:`context`}),` can be rendered in more than one responsive presentation, so their components must obtain changing state from the application and must not introduce a shared singleton DOM id. The `,(0,p.jsx)(t.code,{children:`account`}),` slot appears in the wide rail footer and compact header; it is not repeated inside the compact drawer. `,(0,p.jsx)(t.code,{children:`compactBrand`}),` defaults to `,(0,p.jsx)(t.code,{children:`brand`}),`.`]}),`
...
`,(0,p.jsx)(t.h2,{id:`compact-navigation-lifecycle`,children:`Compact-navigation lifecycle`}),`
`,(0,p.jsxs)(t.p,{children:[`Compact navigation is uncontrolled by default. Use `,(0,p.jsx)(t.code,{children:`defaultCompactNavigationOpen`}),` to choose its initial state and `,(0,p.jsx)(t.code,{children:`onCompactNavigationOpenChange`}),` to observe trigger, close, Escape, and outside-dismissal changes.`]}),`
`,(0,p.jsxs)(t.p,{children:[`Use `,(0,p.jsx)(t.code,{children:`compactNavigationOpen`}),` with `,(0,p.jsx)(t.code,{children:`onCompactNavigationOpenChange`}),` when persistent application route state must close the drawer after successful navigation:`]}),`
`,(0,p.jsx)(t.pre,{children:(0,p.jsx)(t.code,{className:`language-tsx`,children:`const [compactNavigationOpen, setCompactNavigationOpen] = useState(false);
...
/>;
`})}),`
`,(0,p.jsx)(t.p,{children:`Keep destinations as links and close from an observed route change. Do not replace links with buttons or close from every click, because modified clicks, alternate targets, downloads, and external URLs must retain native browser behaviour. Compact open state does not hide or alter the wide navigation rail.`}),`
...
`,(0,p.jsxs)(t.li,{children:[`Pass the current application route as `,(0,p.jsx)(t.code,{children:`contentFocusKey`}),` to move focus to the main target after routed content changes. The focus is deferred until closing overlays have completed their own focus restoration.`]}),`
`]}),`
...
`,(0,p.jsxs)(t.li,{children:[`Do not combine `,(0,p.jsx)(t.code,{children:`compactNavigationOpen`}),` with `,(0,p.jsx)(t.code,{children:`defaultCompactNavigationOpen`}),`, or provide controlled state without `,(0,p.jsx)(t.code,{children:`onCompactNavigationOpenChange`}),`.`]}),`
`]}),`
