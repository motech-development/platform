import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{i as n}from"./react-XnqUzw--.js";import{c as r,n as i,r as a,s as o}from"./blocks-isEuK8QA.js";import{t as s}from"./mdx-react-shim-y1jXGhTh.js";import{NotificationsAndActions as c,n as l,t as u}from"./UserMenu.stories-B6UMUaXL.js";function d(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,...n(),...e.components};return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(o,{of:u,summary:`Application-shell account menu combining represented-user identity, optional notifications, and keyed actions or destinations.`}),`
...
`,(0,p.jsxs)(t.p,{children:[(0,p.jsx)(t.code,{children:`hasUnread`}),` defaults to `,(0,p.jsx)(t.code,{children:`false`}),`. When true, the trigger gets a visible decorative dot. By default its accessible name appends the provider's generic `,(0,p.jsx)(t.code,{children:`unreadNotifications`}),` message. Supply `,(0,p.jsx)(t.code,{children:`unreadLabel`}),` as the complete trigger name when the application knows a localized count, for example `,(0,p.jsx)(t.code,{children:`Notifications (3 unread)`}),`; it replaces the generic unread name rather than appending to it. When `,(0,p.jsx)(t.code,{children:`hasUnread`}),` is false, `,(0,p.jsx)(t.code,{children:`aria-label`}),` remains the complete trigger name, so an application may update it to `,(0,p.jsx)(t.code,{children:`Notifications (0 unread)`}),`.`]}),`
`,(0,p.jsxs)(t.p,{children:[`Open state is uncontrolled by default. Use `,(0,p.jsx)(t.code,{children:`defaultOpen`}),` for an initially open menu and `,(0,p.jsx)(t.code,{children:`onOpenChange`}),` to observe state without owning it. Use `,(0,p.jsx)(t.code,{children:`open`}),` with `,(0,p.jsx)(t.code,{children:`onOpenChange`}),` for controlled state. The callback receives one complete `,(0,p.jsx)(t.code,{children:`false`}),` state for Escape, outside dismissal, trigger toggle, or action activation. The application can use that close report to mark exactly the displayed notification ids read; `,(0,p.jsx)(t.code,{children:`UserMenu`}),` does not own or mutate notification state.`]}),`
`,(0,p.jsxs)(t.p,{children:[`Notification content is rendered only when `,(0,p.jsx)(t.code,{children:`notifications`}),` is supplied; the heading and state are optional supporting content.`]}),`
...
`,(0,p.jsxs)(t.p,{children:[`Translate the accessible label, `,(0,p.jsx)(t.code,{children:`unreadLabel`}),`, notification copy, user-facing state, and action labels. The generic `,(0,p.jsx)(t.code,{children:`Unread notifications`}),` fallback comes from `,(0,p.jsx)(t.code,{children:`BreezeProvider.messages.unreadNotifications`}),`. Keep labels concise enough for narrow shell presentation.`]}),`
`,(0,p.jsx)(t.p,{children:`There is no root loading, invalid, empty, disabled, read-only-open, or error state. Avoid opening an empty menu; render account-loading feedback outside it, disable individual actions during in-flight work, and show any failure in an application-owned alert or page region.`}),`
`,(0,p.jsx)(t.h2,{id:`api`,children:`API`}),`
`,(0,p.jsx)(i,{}),`
`,(0,p.jsx)(t.h2,{id:`common-mistakes-and-related-components`,children:`Common mistakes and related components`}),`
`,(0,p.jsxs)(t.p,{children:[`Do not pass domain objects as ids, combine `,(0,p.jsx)(t.code,{children:`open`}),` with `,(0,p.jsx)(t.code,{children:`defaultOpen`}),`, use a danger style for ordinary navigation, treat `,(0,p.jsx)(t.code,{children:`hasUnread`}),` as application state storage, or place a long notification feed in the popover. Related components: `,(0,p.jsx)(t.a,{href:`?path=/docs/patterns-application-shell-applicationshell--docs`,children:`ApplicationShell`}),`, `,(0,p.jsx)(t.a,{href:`?path=/docs/foundation-avatar--docs`,children:`Avatar`}),`, `,(0,p.jsx)(t.a,{href:`?path=/docs/navigation-menu--docs`,children:`Menu`}),`, and `,(0,p.jsx)(t.a,{href:`?path=/docs/patterns-actions-confirmationdialog--docs`,children:`ConfirmationDialog`}),`.`]})]})}function f(e={}){let{wrapper:t}={...n(),...e.components};return t?(0,p.jsx)(t,{...e,children:(0,p.jsx)(d,{...e})}):d(e)}var p;e((()=>{p=t(),s(),r(),l()}))();export{f as default};