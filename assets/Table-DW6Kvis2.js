import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{i as n}from"./react-XnqUzw--.js";import{c as r,n as i,r as a,s as o}from"./blocks-8AZjJPx9.js";import{t as s}from"./mdx-react-shim-y1jXGhTh.js";import{ControlledSortingAndSelection as c,ResponsiveGroupedSections as l,VariableVirtualizationAndLoading as u,n as d,t as f}from"./Table.stories--Hz3heST.js";function p(e){let t={a:`a`,code:`code`,h1:`h1`,h2:`h2`,li:`li`,p:`p`,pre:`pre`,table:`table`,tbody:`tbody`,td:`td`,th:`th`,thead:`thead`,tr:`tr`,ul:`ul`,...n(),...e.components};return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(o,{of:f,summary:`Responsive compound data table with ordered columns, keyed rows, selection, consumer-owned sorting, actions, grouped sections, loading, and optional virtualization.`}),`
...
`,(0,h.jsxs)(t.li,{children:[(0,h.jsx)(t.code,{children:`Table.Cell`}),` associates one cell with a stable column key and can span adjacent columns.`]}),`
...
`]}),`
`,(0,h.jsxs)(t.p,{children:[`Keep `,(0,h.jsx)(t.code,{children:`Header`}),`, each `,(0,h.jsx)(t.code,{children:`Body`}),`, and optional `,(0,h.jsx)(t.code,{children:`Footer`}),` in meaningful source order. Every data row must cover every visible column in the same order, even after conditional column changes. Use `,(0,h.jsx)(t.code,{children:`Table.Cell colSpan`}),` when one cell intentionally covers adjacent columns.`]}),`
...
`,(0,h.jsxs)(t.p,{children:[(0,h.jsx)(t.code,{children:`layout="responsive"`}),` is the default. It presents compact labelled records below the Breeze small breakpoint and native table columns at wider sizes. `,(0,h.jsx)(t.code,{children:`responsiveGrid`}),` keeps the same compact treatment but shares CSS grid tracks across headings and rows at wider sizes, so content-sized columns remain aligned. Its `,(0,h.jsx)(t.code,{children:`desktopColumns`}),` variant defaults to `,(0,h.jsx)(t.code,{children:`equal`}),`; use `,(0,h.jsx)(t.code,{children:`desktopColumns="mediaDetailsAction"`}),` for content-sized media and action columns around proportionally flexible primary, secondary, and tertiary details. It does not impose fixed icon widths. `,(0,h.jsx)(t.code,{children:`grid`}),` shares those desktop tracks and keeps CSS grid structure at compact sizes too. Both grid layouts provide spacing between columns. Use `,(0,h.jsx)(t.code,{children:`responsiveGrid`}),` or `,(0,h.jsx)(t.code,{children:`grid`}),` only when aligned custom geometry fits the content.`]}),`
`,(0,h.jsxs)(t.p,{children:[(0,h.jsx)(t.code,{children:`Table.Column compactLabel`}),` defaults to `,(0,h.jsx)(t.code,{children:`true`}),`; a literal string heading becomes the compact label. When the heading contains formatting, icons, or other React nodes, provide explicit `,(0,h.jsx)(t.code,{children:`textValue`}),`. Set `,(0,h.jsx)(t.code,{children:`compactLabel`}),` to `,(0,h.jsx)(t.code,{children:`false`}),` for a disclosure or control column that should not label compact cells. Set `,(0,h.jsx)(t.code,{children:`Table.Root compactHiddenColumns`}),` to one stable key, a readonly array, or a `,(0,h.jsx)(t.code,{children:`ReadonlySet`}),` of supporting desktop columns intentionally represented inside another compact cell; one-shot iterators are not supported. Matching cells and grid tracks are omitted below the Breeze small breakpoint while remaining available at wider widths. Declaring this at the root ensures the compact state is present in server-rendered markup. `,(0,h.jsx)(t.code,{children:`align`}),` is `,(0,h.jsx)(t.code,{children:`start`}),`, `,(0,h.jsx)(t.code,{children:`center`}),`, or `,(0,h.jsx)(t.code,{children:`end`}),` and defaults to `,(0,h.jsx)(t.code,{children:`start`}),`. `,(0,h.jsx)(t.code,{children:`width`}),` accepts a CSS width or grid-track size; numbers are pixels. Prefer `,(0,h.jsx)(t.code,{children:`"auto"`}),` or `,(0,h.jsx)(t.code,{children:`"max-content"`}),` for content-sized grid columns and fractional tracks for flexible proportions. For example, `,(0,h.jsx)(t.code,{children:`"minmax(0, 2fr)"`}),` gives a detail column twice the share of a `,(0,h.jsx)(t.code,{children:`"minmax(0, 1fr)"`}),` column. Omitted columns share the remaining width in an equal `,(0,h.jsx)(t.code,{children:`responsiveGrid`}),`. `,(0,h.jsx)(t.code,{children:`boundary="strong"`}),` adds a stronger lower edge; `,(0,h.jsx)(t.code,{children:`none`}),` is the default.`]}),`
`,(0,h.jsxs)(t.p,{children:[(0,h.jsx)(t.code,{children:`Table.Cell colSpan`}),` follows native table semantics and spans the same number of CSS-grid tracks in `,(0,h.jsx)(t.code,{children:`grid`}),` and `,(0,h.jsx)(t.code,{children:`responsiveGrid`}),` layouts. Use a positive integer, start the cell in the first column it covers, and omit the covered cells from that row.`]}),`
`,(0,h.jsxs)(t.p,{children:[`Columns and cells expose `,(0,h.jsx)(t.code,{children:`data-breeze-column="<id>"`}),` and `,(0,h.jsx)(t.code,{children:`data-breeze-cell-column="<id>"`}),` as stable styling hooks. Use them from `,(0,h.jsx)(t.code,{children:`Table.Root className`}),` when a responsive composition needs consumer-owned column visibility or alignment beyond the standard layouts. Cells without `,(0,h.jsx)(t.code,{children:`colSpan`}),` leave CSS-grid placement to consumer `,(0,h.jsx)(t.code,{children:`className`}),` styles; cells with `,(0,h.jsx)(t.code,{children:`colSpan`}),` own their spanned tracks in both compact and wider layouts.`]}),`
`,(0,h.jsx)(a,{of:l}),`
...
`,(0,h.jsx)(t.li,{children:`Do not use padding or manual grid positions to imitate a spanned cell.`}),`
