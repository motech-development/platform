import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{t}from"./jsx-runtime-cM__dR4X.js";import{i as n}from"./react-XnqUzw--.js";import{c as r,n as i,r as a,s as o}from"./blocks-COtIUgNJ.js";import{t as s}from"./mdx-react-shim-y1jXGhTh.js";import{Controlled as c,Default as l,Description as u,Disabled as d,Error as f,Loading as p,ReadOnly as m,Required as h,n as g,t as _}from"./TextField.stories-DQio3WuA.js";function v(e){let t={code:`code`,h1:`h1`,h2:`h2`,p:`p`,...n(),...e.components};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(o,{of:_,summary:`A flat labelled text input with accessible validation.`}),`
`,(0,b.jsx)(t.h1,{id:`textfield`,children:`TextField`}),`
`,(0,b.jsxs)(t.p,{children:[(0,b.jsx)(t.code,{children:`TextField`}),` is a closed, single-line text input. Its `,(0,b.jsx)(t.code,{children:`label`}),`, optional
`,(0,b.jsx)(t.code,{children:`description`}),` and optional `,(0,b.jsx)(t.code,{children:`error`}),` are flat props, so applications do not need
...
the next string value, never a DOM event. Use `,(0,b.jsx)(t.code,{children:`defaultValue`}),` and an optional
`,(0,b.jsx)(t.code,{children:`onChange`}),` for uncontrolled usage; the two forms cannot be mixed.`]}),`
`,(0,b.jsx)(a,{of:c}),`
