import{s as o,j as e,L as M,B as N}from"./BaseStyles-ba442780.js";import{d as a}from"./index-49721cb5.js";import{F as T,b as W,c as L}from"./index.es-07c84961.js";import{r as i}from"./index-8b3efc3f.js";import{u as O}from"./usePopper-f596e70c.js";import{B as H}from"./Button-46c99480.js";import{D as K}from"./DataTable-d7737561.js";import{u as G}from"./useOutsideClick-189345a3.js";import{T as w}from"./TableCell-f4d1c509.js";import{T as J}from"./Typography-fc480bb2.js";import"./_commonjsHelpers-de833af9.js";import"./index-633d3215.js";import"./index-8d47fad6.js";import"./index-6bb76072.js";import"./BaseButton-7c7255d1.js";import"./polished.esm-8995ec32.js";import"./Loader-4ebfd022.js";import"./TableHead-6c50aa64.js";const Q=o.div`
  height: 0;
  position: absolute;
  width: 0;
...
`,te={primary:{background:"#161616",border:"#222",colour:"#fff"},secondary:{background:"#f6f9fc",border:"#ccc",colour:"#333"}},ae=o.div`
  ${({$fixed:r})=>`
    ...
    z-index: 10;
  `}
`,m=({children:r,colour:t="primary",element:c="header",fixed:s=!1})=>e.jsx(M,{theme:te,children:e.jsx(ae,{$fixed:s,children:e.jsx(oe,{as:c,$colour:t,children:e.jsx(re,{children:r})})})}),u=m;try{m.displayName="AppBar",m.__docgenInfo={description:"",displayName:"AppBar",props:{colour:{defaultValue:{value:"primary"},description:"",name:"colour",required:!1,type:{name:"string | number"}},element:{defaultValue:{value:"header"},description:"",name:"element",required:!1,type:{name:"enum",value:[{value:'"div"'},{value:'"header"'}]}},fixed:{defaultValue:{value:"false"},description:"",name:"fixed",required:!1,type:{name:"boolean"}}}}}catch{}const Ae={component:u,decorators:[a.withKnobs]},_=o(J)`
  && {
    margin: 0;
  }
...
}`,...(A=(j=p.parameters)==null?void 0:j.docs)==null?void 0:A.source}}};const Ne=["BasicAppBar","AppBarWithNotifications"];export{p as AppBarWithNotifications,l as BasicAppBar,Ne as __namedExportsOrder,Ae as default};
