import{s as _,j as r,B}from"./BaseStyles-5cc577b5.js";import{d as s}from"./index-e06dce00.js";import{C as x}from"./Card-fc232f28.js";import{T as w}from"./Typography-7cd11c27.js";import{R as E,C as S}from"./Row-e46a8eb7.js";import{r as d}from"./index-cb576d23.js";import"./_commonjsHelpers-de833af9.js";const k=()=>{const e=()=>({height:window.innerHeight,width:window.innerWidth}),[t,n]=d.useState(e),o=()=>{n(e)};return d.useEffect(()=>(window.addEventListener("resize",o),()=>{window.removeEventListener("resize",o)}),[]),t},$=()=>{const e=window.matchMedia("(min-width: 992px)"),t=window.matchMedia("(min-width: 768px)"),n=window.matchMedia("(min-width: 576px)");return e.matches?"lg":t.matches?"md":n.matches?"sm":"xs"},z=()=>{const[e,t]=d.useState("xs"),{width:n}=k();return d.useEffect(()=>{t($)},[n]),e},I=_.div`
  ${({$gutter:e})=>`
    margin-bottom: ${e};
  `}
